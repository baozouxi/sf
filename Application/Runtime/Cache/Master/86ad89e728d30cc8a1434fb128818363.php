...
<head>
   ...
   <!--  <script type="text/javascript" src='js/jquery.min.js'></script> -->
    ...
    <script type="text/javascript" src="/Public/js/addAdmin.js"></script>
    <title>管理首页</title>
</head>
<body>
    <div id="body_wrap">
                        ...
                        <div class="addForm">
                            <div class="fields">
                              ...
                              <ul class="input">
                                ...
                                <li><input type="text" name="username[]" class="username"></li>
                                <li><input type="password" name="pass[]" class='password'></li>
                                <li>
                                    <select name="admin_part[]">
