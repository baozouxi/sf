...
<head>
    ...
    <script type="text/javascript" src="/Public/js/adminLogin.js"></script>
    ...
    <div id="login">
        <div class="wrap">
            <div class="box">
                ...
                <!--用户名登录部分-->
                     <form action="<?php echo U('usernameLogin');?>" method="post" name="username"  >
                    <input type="hidden" name='_unique' value="<?php echo ($_unique); ?>">
                        <div class="input_item">
                            用户名：<input type="text" name='username'>
                            <p style="text-align: center; font-size:13px;color:red;">用户名有误</p>
                        </div>
                        <div class="input_item">
                            密　码：<input type="password" name='password'>
                            <p style="text-align: center; font-size:13px;color:red;">请填写密码</p>
                        </div>
                        <div class="input_item verify">
                            <div class="ver_left">
                                验证码：<input type="text" name='verify'>
