...
<head>
   ...
   <!--  <script type="text/javascript" src='js/jquery.min.js'></script> -->
    ...
    <script type="text/javascript" src="/Public/js/addDoctor.js"></script>
    <title>管理首页</title>
</head>
<body>
    <div id="body_wrap">
    ...
    <div class="sys_msg_tips"></div>
        ...
        <div id="con">
            ...
            <!--导航栏部分-->
                ...
                <div class="form">
                    <div class="title">
                        <div class="left">当前医院：<a href="/Master" title='点我返回首页'><?php echo ($hospital_name); ?></a></div>
                        <!-- <div class="right">
                ...
                <form action="<?php echo U('addDoctor');?>" method="post" name="add">                    <!--内容主体-->
                    <div class="form_con">
                        <div class="addForm">
                            <div class="fields">
                              <ul>
                              ...
                              <ul class="input">
                                ...
                                <li><input type="text" name="age[]" class="age" maxlength="3"></li>
                                <li>
                                    <select name="sex[]">
                                ...
                                <li><input type="text" name="summary" class='summary'></li>
                              </ul>
                            </div>
                        </div>
