    ...
    <!-- 头部 -->
        ...
        <div id="con">
            ...
            <!--导航栏部分-->
                ...
                <div class="form">
                    <div class="title">
                        <div class="left">当前医院：<a href='/' title='点我返回首页'><?php echo ($hospital_name); ?></a><<span><?php echo ($patient["name"]); ?></span></div>
                        <div class="right">
                        ...
                        <div class="user_info">
                            <div class="fields">
                                ...
                                <ul class="patient">
                                    ...
                                    <li><input type="text" value="<?php echo ($patient["hospital_date"]); ?>" name='hospital_date' readonly="true"></li>
                                    <li><input type="text" value="<?php echo ($patient["name"]); ?>" name='name' ></li>
                                    ...
                                    <li class="type"><?php echo ($patient["illness"]); ?></li>
                                    <li class="type_select">
                                        <select name="illness">
                                            <?php if(is_array($illness)): $i = 0; $__LIST__ = $illness;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ill): $mod = ($i % 2 );++$i; if($key == $patient['illness']): ?><option value="<?php echo ($key); ?>" selected="selected"><?php echo ($key); ?></option>
                                                    
                                                <?php else: ?> <option value="<?php echo ($key); ?>"><?php echo ($key); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
